...
// This parser was copied "verbatim" here from mikelward/ci-commit-artifact
// (where it originated), and the two copies then drifted independently for
// a while before being reconciled into mikelward/yaml-lite, which is now
// the source of truth — fix a bug there first, then re-sync this copy (see

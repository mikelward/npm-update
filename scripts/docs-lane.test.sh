...
check "code file makes it code"           0 "docs_only=false" FILES="README.md check-dependency-update.mjs"
check "the shim is code"                  0 "docs_only=false" FILES="vitest-shim.mjs"
